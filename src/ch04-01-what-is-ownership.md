...
เมื่อคุณเข้าใจ ownership คุณจะมีพื้นฐานสำคัญที่ทำให้ Rust ไม่เหมือนภาษาโปรแกรมอื่นๆ ในบทนี้คุณจะเรียนรู้แนวคิด ownership ด้วย data strucutre พื้นฐานคือ: strings
